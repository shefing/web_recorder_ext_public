...
4. Click the extension icon to show the extension popup, start recording, etc... The dev build of the extension will be grey to difrentiate from the production version.
...
The Electron App version will open recording in a new window. It is designed to support Flash, better support for IPFS sharing.
